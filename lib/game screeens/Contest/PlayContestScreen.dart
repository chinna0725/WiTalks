...
import '../PersonalityQuiz/ResultScreen.dart';


class PlayContestScreen extends StatefulWidget {
  final imageMap;

  const PlayContestScreen({super.key, required this. imageMap});

  @override
  State<PlayContestScreen> createState() => _PlayContestScreenState();
}

class _PlayContestScreenState extends State<PlayContestScreen> {
